  ...
  return <div className="min-h-screen bg-background relative">
      ...
      <div className="relative">
        ...
        <div className="relative z-10 pt-32 pb-16 text-center">
          <h1 style={{
          color: '#353333'
        }} className="font-avenir-heavy text-2xl font-medium md:text-5xl">Cómo comprar tu joya
en tres pasos</h1>
        </div>
        ...
        <div className="relative h-screen">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center items-center px-6">
            ...
            transform: `translateY(${getTranslateY(400, 600)}px)`
              ...
              <div className="bg-black/55 backdrop-blur-sm p-8 w-full rounded-lg">
        ...
        <div className="relative h-screen">
          ...
          <div className="relative z-10 h-full flex flex-col justify-start items-start px-6 md:px-16 pt-32">
            ...
            transform: `translateY(${getTranslateY(800, 1000)}px)`
              ...
              <span className="font-avenir-medium text-8xl md:text-9xl block mb-4" style={{
              color: '#353333'
            }}>2</span>
              <h2 className="font-avenir-medium text-2xl md:text-3xl" style={{
              color: '#353333'
            }}>
            ...
            <div className="max-w-xl space-y-4" style={{
            opacity: getOpacity(1000, 1200),
            transform: `translateY(${getTranslateY(1000, 1200)}px)`
          }}>
              <p className="font-avenir-book text-base leading-relaxed" style={{
              color: '#353333'
            }}>
        ...
        <div className="relative h-screen">
          ...
          <div className="relative z-10 h-full flex flex-col justify-start items-start px-6 md:px-16 pt-32">
            <div className="mb-1 flex items-start justify-between w-full max-w-4xl" style={{
            ...
            <div className="max-w-xl space-y-2" style={{
      ...
      <div className="relative z-10 py-24 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-0">
            ...
            <FAQItem question="¿Cómo sé mi talla?" answer="La talla es siempre a medida; si no conoces la tuya, verifica la sección de cómo saber mi talla, y si todavía quedas con dudas, contáctame y te guiaré para determinarla." />
