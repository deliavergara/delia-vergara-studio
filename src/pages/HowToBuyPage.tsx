...
const HowToBuyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* GALERÍA DE FOTOS CON SNAPSCROLL */}
      <div
      ...
      >
        {/* 1ª pantalla */}
        <section
          className="snap-screen bg-cover bg-center relative"
          style={{
          ...
          <div className="screen-content justify-start items-center">
            <div className="max-w-2xl">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-avenir-medium text-white text-base md:text-lg mb-2">
                    En stock:
                  </h3>
                  <p className="font-avenir-light text-white text-sm md:text-base leading-relaxed">
                    Piezas listas para envío inmediato desde Valencia (España) o
                    Santiago (Chile).
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-avenir-light text-white text-sm md:text-base leading-relaxed">
                    La mayoría de mis diseños se pueden volver a producir
                ...
                <div>
                  ...
                  <p className="font-avenir-light text-white text-sm md:text-base leading-relaxed">
                    Si tienes una idea, hablemos para crear juntos una joya
                    completamente nueva.
                  </p>
                </div>
              </div>
          ...
          <div className="screen-content justify-start items-center">
            <div className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <p className="font-avenir-light text-white text-sm md:text-base leading-relaxed">
                  Confirmaremos juntos los detalles, la talla, el precio final y
                  los tiempos de creación o envío.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* PREGUNTAS FRECUENTES - fuera del snapscroll */}
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-0">
            ...
            <FAQItem
              ...
              answer={
                <>
                  La talla es siempre a medida; si no conoces la tuya, verifica
                  la sección{" "}
                  <span
                  ...
                  y si todavía quedas con dudas, contáctame y te guiaré para
                  determinarla.
                </>
              }
            />
      ...
      <div className="border-t border-border pt-16 relative px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            <img
              src={buildGitHubRawUrl(
                "public/lovable-uploads/Material%20de%20Apoyo/Logo/isologo.png"
              )}
...
const FAQItem = ({ question, answer }: FAQItemProps) => {
  ...
  return (
    <div className="border-b border-gray-200 last:border-b-0">
      ...
      >
        <span
          className="font-avenir-book text-lg pr-8"
          style={{ color: "#353333" }}
        >
          {question}
        </span>
      ...
      >
        <p
          className="font-avenir-light text-base leading-relaxed"
          style={{ color: "#353333" }}
        >
          {answer}
        </p>
