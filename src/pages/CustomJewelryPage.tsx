...
import { buildCustomJewelryUrl } from "@/lib/supabase-config";
  ...
  return <div className="relative">
      ...
      <div className="fixed inset-0 w-full h-full overflow-hidden z-0">
        ...
        opacity: 0.95
          ...
          <source src={buildCustomJewelryUrl("video_fondo_joya_medida.mp4")} type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 min-h-[300vh] pt-24">
        <div className="max-w-2xl mx-auto px-6 space-y-8">
          ...
          opacity: getFadeOutOpacity(elementPositions.title)
            ...
            <h1 className="font-avenir-medium text-white lg:text-6xl text-center md:text-4xl font-medium text-2xl">
              JOYAS A MEDIDA
            </h1>
          </div>
          ...
          <div className="space-y-16 py-8">
            ...
            opacity: getResponsiveOpacity(elementPositions.step1)
              ...
              <h3 className="font-avenir-book text-white font-bold text-base md:text-lg">Hablemos de tu idea</h3>
          ...
          opacity: getResponsiveOpacity(elementPositions.closing)
            ...
            <p className="font-avenir-book text-white leading-relaxed text-lg md:text-xl">
