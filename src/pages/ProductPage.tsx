            ...
            <div className="space-y-6">
                    ...
                    <>
                      ...
                      {technicalLines.length > 0 && (
                        <div className="space-y-0 pt-2">
                          {technicalLines
                            .filter(line => !/(contáctame|contactame)/i.test(line))
                            .map((line, index) => (
                              <p 
                                key={index} 
                                className="font-thin tracking-body leading-body text-product-description text-sm italic"
                              >
                                {line}
                              </p>
                            ))}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      <button 
                        ...
                        className={cn(
                          "px-4 py-2 rounded-full border transition-quick font-elegant font-light text-muted-foreground text-sm", 
              ...
              <div className="border-t pt-6">
                <div className="font-avenir font-medium text-lg text-product-name tracking-title">
                  {currentPrice === 0 
                    ? 'Por encargo' 
                    : `${selectedCurrency === 'EUR' ? '€' : '$'}${currentPrice?.toLocaleString() || '0'}`}
                </div>
