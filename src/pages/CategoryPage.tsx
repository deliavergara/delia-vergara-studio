...
const CategoryPage = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="pt-8 pb-8 text-center">
        <img src="https://github.com/deliavergara/delia-vergara-studio/raw/main/public/lovable-uploads/Material%20de%20Apoyo/Logo/logo%20gris_Mesa%20de%20trabajo%201.png" alt="Delia Vergara Logo" className="h-12 mx-auto mb-8" />
